...
public class ServletMovimientos2 extends ServletTemplateAjax
{
	// -----------------------------------------------------------------
	// Atributos
	// -----------------------------------------------------------------
	...
	public void escribirContenido( HttpServletRequest request, HttpServletResponse response ) throws IOException
	{
		...
		if(criterio.equals("nombre")){
			decision = "ISTRUMENTO_FINANCIERO.NOMBRE NOT LIKE '" +palabra+ "'";
		}
		else if(criterio.equals("tipo")){
			decision = "TIPO_VALOR.NOMBRE NOT LIKE '" +palabra+ "'";
		}
		else if(criterio.equals("rentabilidad")){
			decision = "RENTABILIDAD.NOMBRE NOT LIKE '" +palabra+ "'";
		}
		else if(criterio.equals("comisionista")){
			decision = "COMISIONISTA.NOM_REPRESENTANTE NOT LIKE '" +palabra+ "'";
		}
		else if(criterio.equals("inversionista")){
			decision = "NOMBRE_REPRESENTANTE NOT LIKE '" +palabra+ "'";
		}
		else if(criterio.equals("oferente")){
			decision = "OFERENTE.NOM_REPRESENTANTE NOT LIKE '" +palabra+ "'";
		}
